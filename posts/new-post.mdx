...
<CustomImage src="https://raw.githubusercontent.com/Codefreyy/blog-posts/main/images/me.jpeg" alt="me">
...
return (
  <html lang="en">
    ...
    <Script
      async
      src="https://www.googletagmanager.com/gtag/js?id=G-YOUR-ID-NUMBER"
    />
  </html>
)
```
...
<script
  src="https://www.googletagmanager.com/gtm.js?id=G-YOUR-ID-NUMBER"
  id="_next-gtm"
  data-ntpc="GTM"
  data-nscript="afterInteractive"
></script>
